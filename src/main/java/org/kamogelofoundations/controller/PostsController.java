...
public class PostsController {
	...
	public ModelAndView create(){
		...
		List<Post> posts = postDAO.findAllByAuthorOrderByDateDesc(user);
		modelAndView.addObject("posts",posts);
		Post post = new Post();
		modelAndView.addObject(post);
		modelAndView.setViewName("/blog/posts/create");
		return modelAndView;		
	}
	/**
	 * Display form to create a post
	...
	public ModelAndView create(@Valid Post post, BindingResult bindingResult){
		...
		if( !bindingResult.hasErrors() ){
			...
			modelAndView.addObject("successMessage", "Request Has been placed");
